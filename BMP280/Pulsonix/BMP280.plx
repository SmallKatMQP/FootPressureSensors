...
(library Library_1
	...
	(patternDef "8-PIN-METAL-LID-LGA_1" (originalName "8-PIN-METAL-LID-LGA_1")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.366, 0.129) (textStyleRef "Normal") (isVisible True))
		)
		...
		(layerContents (layerNumRef 18)
			(arc (pt 1.455, 1.134) (radius 0) (width 0.254))
		)
	)
	...
	(compDef "BMP280" (originalName "BMP280") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(attr "<Hyperlink>" "https://ae-bst.resource.bosch.com/media/_tech/media/datasheets/BST-BMP280-DS001-19.pdf")
	)
